describe("UnitTests", function() {
  it("compares_objects", function() {
    ...
    expect(selectionSort(arr3, comp2)).toEqual(arr3Soln);
  });
  it("compares_strings", function() {
    // Failure message:
    // This test has no failure messages
    ...
    expect(selectionSort(arr, strComp)).toEqual(arrSoln);
  });
